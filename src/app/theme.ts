...
export const themeVariables: Record<Exclude<AccentTheme, 'custom'>, CSSProperties> = {
  ...
  sakura: {
    ...
    '--panel-soft': '#fffafd',
    '--feature-bg':
      'linear-gradient(90deg, rgba(255, 221, 238, 0.88), rgba(255, 244, 249, 0.84))',
    '--feature-card': 'rgba(255, 247, 251, 0.86)',
    '--feature-field': 'rgba(255, 252, 254, 0.72)',
    '--rail-bg': '#fde8f3',
    '--middle-bg': 'rgba(247, 221, 234, 0.9)',
    '--middle-hover': 'rgba(255, 255, 255, 0.36)',
    '--middle-active': 'rgba(105, 77, 91, 0.12)',
    '--rose': '#ffabcc',
    '--rose-strong': '#c97c9b',
    '--rose-deep': '#a96582',
    '--rose-soft': '#ffeaf3',
